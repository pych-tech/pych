    ...
    def lex(self, string: str) -> list[Token]:
        ...
        for token in string:
            ...
            if token.isalpha():
                ...
                if is_string_token:
                    if token_property == "MINUS" or token_property == "UNDERSCORE":
                        evalutated_token_stream += token
                    else:
                        token_stream = ""
                    ...
                    token_map.append(Token(token_stream, "FLOAT"))
                    token_map.append(Token(token, token_property))
        ...
        if evalutated_token_stream:
            ...
            if is_decimal:
                ...
                token_map.append(Token(token_stream, "UNKNOWN"))

            evalutated_token_stream = ""

        token_map[0] = Token(token_map[0].token_value, "STREAM-IDENTIFIER")
        return token_map
